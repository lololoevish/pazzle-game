...
impl VictoryScene {
    ...
    fn draw_background(&self) {
        for i in 0..screen_height() as i32 {
            ...
            let color = Color::new(0.02 + t * 0.05, 0.04 + t * 0.08, 0.08 + t * 0.16, 1.0);
        ...
        draw_circle(
            ...
            118.0,
            110.0 + pulse * 22.0,
            Color::from_rgba(255, 220, 128, (30.0 + pulse * 28.0) as u8),
        );
        draw_circle(
            screen_width() * 0.5,
            118.0,
    ...
    fn draw_summary_panel(&self) {
        let panel = Rect::new(94.0, 176.0, screen_width() - 188.0, 310.0);
        draw_rectangle(
            panel.x,
            panel.y,
            panel.w,
            panel.h,
            Color::from_rgba(8, 14, 26, 228),
        );
        draw_rectangle(
            panel.x + 10.0,
            panel.y + 10.0,
